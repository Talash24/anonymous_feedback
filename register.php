<?php
   ...
   if($_SERVER['REQUEST_METHOD'] === 'POST'){
       ...
       if(empty($_POST['confirm_password'])){
          $errors['confirm_password'] = 'Please provide password again.';
       }
       ...
       if($_POST['password'] !== $_POST['confirm_password']){
           $errors['confirm_password'] = 'Please provide valid password';
       }
                    ...
                    <div class="mt-10 mx-auto w-full max-w-xl">
                        <form class="space-y-6" action="register.php" method="POST" novalidate>
                            <div>
                                ...
                                <div class="mt-2">
                                    <input id="name" name="name" type="text" required  class="block w-full rounded-md border-0 py-1.5text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
