    ...
    <div class="relative flex min-h-screen overflow-hidden bg-gray-50 py-6 sm:py-12">
        ...
        <div class="relative max-w-7xl mx-auto">
            <div class="flex justify-end">
                <span class="block text-gray-600 font-mono border border-gray-400 rounded-xl px-2 py-1">Your feedback form link: <strong>http://localhost/assignment3/feedback.php</strong></span>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                  <?php foreach($feedbacks as $feedback): ?>
                    ...
                    <div class="focus:outline-none">
                        <p class="text-gray-500"><?php echo htmlspecialchars($feedback['about']) ?></p>
                    </div>
                </div>
                  <?php endforeach; ?>
            </div>
